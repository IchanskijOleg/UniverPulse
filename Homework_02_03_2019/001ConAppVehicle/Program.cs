...
namespace _001ConAppVehicle
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CVehicle plane = new CPlane("Boing 737", 3, 3, 100000, 900, 1989, 10000, 130);
            CVehicle plane1 = new CPlane("AN-158", 4, 4, 100000, 800, 2010, 10000, 86);

            CVehicle ship = new CShip("Titanic", 5, 5, 300000, 1500, 1912, "New York City", 2208);
            CVehicle ship1 = new CShip("Aphrodite", 6, 6, 20000, 20, 2009, "Kiev", 200);
